        ...
        <div class="px-6 py-4 border-b border-gray-200 flex flex-col gap-4">
            <div class="flex items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <x-button
                        variant="success"
                        :href="route('products.export', ['format' => 'xlsx'] + request()->query())">
            ...
            <div class="flex items-center gap-3">
                ...
                <div class="mt-6">
                    <a href="{{ route('products.index') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('products.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Nom <span class="text-red-600">*</span></label>
                        <input
                            name="name"
                            value="{{ old('name') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Type <span class="text-red-600">*</span></label>
                        <select
                            id="product-type"
                            name="type"
                            required
                            onchange="toggleProductTypeFields()"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Prix Vente<span class="text-red-600">*</span></label>
                        <input
                            type="text"
                            name="prix_vente"

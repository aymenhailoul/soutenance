            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow p-6">
                    ...
                    <div class="relative">
                        ...
                        <div x-show="searchResults.length > 0" class="absolute z-10 w-full mt-1 bg-white rounded-md shadow-lg border border-gray-200 max-h-60 overflow-y-auto" @click.away="searchResults = []">
                                ...
                                >
                                    <div>
                                        ...
                                        <div class="text-xs text-gray-500">
                                            ...
                                            Stock: <span :class="product.stock > 0 ? 'text-green-600' : 'text-red-600'" x-text="product.stock"></span>
                                        </div>
                                    </div>
                                    <div class="text-sm font-semibold text-gray-900" x-text="formatPrice(product.prix_vente)"></div>
                                </div>
                            </template>
                        </div>
                    </div>
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider w-24">Prix</th>
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider w-32">Qté</th>
                                <th class="px-6 py-3 text-right text-xs font-medium text-gray-500 uppercase tracking-wider w-32">Remise</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <template x-for="(item, index) in items" :key="item.product_id">
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-right text-sm text-gray-500" x-text="formatPrice(item.unit_price)"></td>
                                    <td class="px-6 py-4">
                                        <input 
                                            type="number" 
                                            x-model.number="item.quantity" 
                                            min="1" 
                                            :max="item.type === 'Product' ? item.max_stock : null"
                                    ...
                                    <td class="px-6 py-4 text-right text-sm font-semibold text-gray-900" x-text="formatPrice((item.unit_price * item.quantity) - item.discount)"></td>

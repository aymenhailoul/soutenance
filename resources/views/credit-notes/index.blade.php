...
@section('content')
    <div class="p-8">
        <div class="mb-6 flex items-center justify-between">
            <h1 class="text-3xl font-bold text-gray-900">Retours (Avoirs)</h1>
            ...
            <form method="GET" action="{{ route('retours.index') }}" id="filter-form">
                <div class="flex flex-wrap items-end gap-4">
                    ...
                    <div class="min-w-[200px]">
                        <label class="block text-sm font-semibold text-gray-900 mb-2" for="credit-note-number">
                            N° Avoir
                        </label>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">N° Avoir</th>
        ...
        <div class="bg-white rounded-xl shadow-xl w-full max-w-2xl mx-4 max-h-[90vh] overflow-y-auto">
            <div class="p-6">
                ...
                <div class="flex items-center justify-between mb-6">
                    <h2 class="text-xl font-semibold text-gray-900">Détails de l'Avoir</h2>
                    <button onclick="closeCreditNoteModal()" class="text-gray-400 hover:text-gray-600 transition-colors">
                ...
                <div class="space-y-3 mb-6">
                    <div class="flex justify-between">
                        <span class="text-sm font-medium text-gray-600">N° Avoir:</span>
                        <span class="text-sm font-semibold text-orange-600" id="modal-credit-note-number"></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm font-medium text-gray-600">Facture associée:</span>
                        <span class="text-sm text-gray-900" id="modal-invoice-number"></span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm font-medium text-gray-600">Date:</span>
                        <span class="text-sm text-gray-900" id="modal-credit-date"></span>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <span class="text-sm text-gray-900" id="modal-reason"></span>
                    </div>
                </div>

                <!-- Items Table -->
                <div class="border-t border-gray-200 pt-4">
                    <h4 class="text-sm font-semibold text-gray-700 mb-3">Articles retournés:</h4>
                ...
                <div class="border-t-2 border-gray-300 mt-4 pt-4">
                    <div class="flex justify-between items-center">
                        ...
                        <span class="text-2xl font-bold text-red-600" id="modal-total"></span>
                    </div>
                </div>

        ...
        <div class="px-6 py-4 border-b border-gray-200 flex flex-col gap-4">
            ...
            <div class="flex items-center gap-3">
                <div class="relative flex-1 max-w-md">
                    <label class="block text-sm font-semibold text-gray-900 mb-2" for="employee-search">
                        Rechercher employé
                    </label>
                    <div class="relative">
                ...
                <div class="mt-6">
                    <a href="{{ route('employees.index') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-gray-700 bg-gray-100 rounded-lg hover:bg-gray-200 transition-colors">
            ...
            <table class="min-w-full">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left px-6 py-3 text-sm font-semibold text-gray-700">CIN</th>
                        <th class="text-left px-6 py-3 text-sm font-semibold text-gray-700">Salaire</th>
                        <th class="text-left px-6 py-3 text-sm font-semibold text-gray-700">Date Embauche</th>
...
<div
    ...
    <div class="bg-white rounded-xl shadow-xl w-full max-w-3xl mx-4">
        <div class="flex items-center justify-between px-6 py-4 border-b border-gray-200">
            <h2 class="text-lg font-semibold text-gray-900">Ajouter employé</h2>
            <button
                type="button"
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('employees.store') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Nom Complet<span class="text-red-600">*</span></label>
                        <input
                            name="name"
                            value="{{ old('name') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">CIN <span class="text-red-600">*</span></label>
                        <input
                            name="cin"
                            value="{{ old('cin') }}"
                            class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500"
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Salaire <span class="text-red-600">*</span></label>
                        <input
                            type="text"
                            name="salary"
                            value="{{ old('salary') }}"
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-gray-900 mb-2">Date Embauche <span class="text-red-600">*</span></label>
                        <input
                            type="date"
                            name="joined_at"
                            value="{{ old('joined_at') }}"
